...
if {[info exists STRATEGY_SYNTH_OPTIONS] && $STRATEGY_SYNTH_OPTIONS ne ""} {
    set synth_cmd [concat $synth_cmd $STRATEGY_SYNTH_OPTIONS]
} else {
    lappend synth_cmd -keep_equivalent_registers
}

if {[info exists STRATEGY_SYNTH_DIRECTIVE] && $STRATEGY_SYNTH_DIRECTIVE ne ""} {
    lappend synth_cmd -directive $STRATEGY_SYNTH_DIRECTIVE
}

puts "AWS FPGA: synth command: $synth_cmd"
eval $synth_cmd
