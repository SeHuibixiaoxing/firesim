...
# Module Mapping
########################################
# The small-shell PCIS bus is physically in SLR1.  Keep the CL-side PCIS
# handoff registers and FireSim PCIS bridge logic in SLR1 so the shell-to-CL
# boundary does not route first into SLR2 and then back to SLR1.
